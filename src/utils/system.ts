...
export async function getMemoryStats(): Promise<MacOSMemory | null> {
  // Get page size
  ...
  if (!vmResult.success) return null;
...
export async function getDiskStats(): Promise<MacOSDisk[]> {
...
export async function getSystemInfo(): Promise<MacOSSystem | null> {
